...
static String *f_cl;
static String *f_clhead;
static String *f_clwrap;
...
class CFFI:public Language {
  ...
  // Includes structs
  void emit_struct_union(Node *n, bool un = false) {
#ifdef CFFI_DEBUG
  ...
  /* utilities */
  String *convert_literal(String *literal, String *type, bool try_to_split = true) {
...
static Language *new_swig_cffi() {
  return new CFFI();

}

extern "C" Language *swig_cffi(void) {
  return new_swig_cffi();
}
